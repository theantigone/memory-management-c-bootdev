...
### How it works:
1. Download the [``unit`` framework](https://github.com/nemequ/munit/)
2. Download the exercise files on [Boot.dev's Memory Management chapters](https://www.boot.dev/lessons/44a4421c-cc49-4472-bbad-a14f81f860b4) (exercise.c, exercise.h, main.c, etc.)
...
> Refer to the [µnit's documentation](https://nemequ.github.io/munit/) on how to format the unit test cases to their default configurations.
